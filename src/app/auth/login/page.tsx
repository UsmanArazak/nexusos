    ...
    <div className="min-h-screen flex items-center justify-center bg-[#FAFAF7] px-4 sm:px-6 py-8 font-sans">
      <div className="bg-white border border-[#E8E8E2] rounded-2xl p-6 sm:p-8 w-full max-w-md shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="password" className="block text-sm font-medium text-[#4B4B4B] mb-1 flex justify-between">
              <span>Password</span>
              <a href="#" className="text-primary hover:text-primary-hover transition-colors">Forgot?</a>
            </label>
            <input
              id="password"
              type="password"
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3 rounded-xl bg-primary text-white font-semibold hover:bg-primary-hover transition-all text-sm disabled:opacity-70 disabled:cursor-not-allowed mt-2"
          >
        ...
        <p className="text-center text-sm text-[#9B9B9B] mt-6">
          ...
          <Link href="/register" className="text-[#0F0F0F] font-medium hover:text-primary transition-colors">
