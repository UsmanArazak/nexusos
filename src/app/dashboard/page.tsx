  ...
  return (
    <div className="p-8 max-w-7xl mx-auto font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {/* Students Stat */}
        <div className="bg-[#FAFAF7] border-l-4 border-l-[#C8A84B] border border-y-[#E8E8E2] border-r-[#E8E8E2] rounded-xl p-6 shadow-sm">
          ...
          {studentsCount === 0 && (
            <Link href="/dashboard/students/new" className="text-xs text-[#C8A84B] font-semibold hover:underline mt-2 inline-block">
              + Add First Student
            </Link>
          )}
        </div>
        ...
        <div className="bg-[#FAFAF7] border-l-4 border-l-[#C8A84B] border border-y-[#E8E8E2] border-r-[#E8E8E2] rounded-xl p-6 shadow-sm">
          ...
          {staffCount === 0 && (
            <Link href="/dashboard/staff/new" className="text-xs text-[#C8A84B] font-semibold hover:underline mt-2 inline-block">
              + Add First Staff
            </Link>
          )}
        </div>
        ...
        <div className="bg-[#FAFAF7] border-l-4 border-l-[#C8A84B] border border-y-[#E8E8E2] border-r-[#E8E8E2] rounded-xl p-6 shadow-sm">
          ...
          {classesCount === 0 && (
            <Link href="/dashboard/classes/new" className="text-xs text-[#C8A84B] font-semibold hover:underline mt-2 inline-block">
              + Create Class
            </Link>
          )}
        </div>
        ...
        <div className="bg-[#FAFAF7] border-l-4 border-l-[#C8A84B] border border-y-[#E8E8E2] border-r-[#E8E8E2] rounded-xl p-6 shadow-sm">
          ...
          {pendingFeesCount === 0 && (
            <Link href="/dashboard/fees" className="text-xs text-[#C8A84B] font-semibold hover:underline mt-2 inline-block">
              + Configure Fees
            </Link>
          )}
        </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Link href="/dashboard/students/new" className="flex flex-col items-center justify-center bg-white border border-[#E8E8E2] p-4 rounded-xl hover:bg-[#FAFAF7] hover:border-[#C8A84B] transition-all text-[#1A1A1A] group shadow-sm">
            <div className="w-10 h-10 rounded-full bg-[#1A1A1A] text-[#C8A84B] flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
              <span className="text-xl leading-none">+</span>
            </div>
            <span className="text-sm font-medium">Add Student</span>
          </Link>
          
          <Link href="/dashboard/staff/new" className="flex flex-col items-center justify-center bg-white border border-[#E8E8E2] p-4 rounded-xl hover:bg-[#FAFAF7] hover:border-[#C8A84B] transition-all text-[#1A1A1A] group shadow-sm">
            <div className="w-10 h-10 rounded-full bg-[#1A1A1A] text-[#C8A84B] flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
              <span className="text-xl leading-none">👤</span>
            </div>
          ...
          <Link href="/dashboard/attendance" className="flex flex-col items-center justify-center bg-white border border-[#E8E8E2] p-4 rounded-xl hover:bg-[#FAFAF7] hover:border-[#C8A84B] transition-all text-[#1A1A1A] group shadow-sm">
            <div className="w-10 h-10 rounded-full bg-[#1A1A1A] text-[#C8A84B] flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
          ...
          <Link href="/dashboard/fees/collect" className="flex flex-col items-center justify-center bg-white border border-[#E8E8E2] p-4 rounded-xl hover:bg-[#FAFAF7] hover:border-[#C8A84B] transition-all text-[#1A1A1A] group shadow-sm">
            <div className="w-10 h-10 rounded-full bg-[#1A1A1A] text-[#C8A84B] flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
              <span className="text-xl leading-none">💳</span>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white border border-[#E8E8E2] rounded-2xl shadow-sm overflow-hidden">
          <div className="p-6 border-b border-[#E8E8E2] flex justify-between items-center">
            ...
            <Link href="/dashboard/students" className="text-sm text-[#C8A84B] hover:text-[#A8892E] font-medium">View All</Link>
          </div>
                ...
                return (
                  <div key={event.id} className="p-5 flex gap-4 hover:bg-[#FAFAF7] transition-colors">
                    <div className="flex-shrink-0 w-12 h-12 bg-[#FAFAF7] border border-[#E8E8E2] rounded-xl flex flex-col items-center justify-center">
                      <span className="text-[10px] font-bold text-[#C8A84B] uppercase">{month}</span>
